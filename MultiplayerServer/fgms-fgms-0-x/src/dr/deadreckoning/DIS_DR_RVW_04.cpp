// Generated from /DR/src/deadreckoning/DIS_DR_RVW_04.java
#include <deadreckoning/DIS_DR_RVW_04.hpp>
...
deadreckoning::DIS_DR_RVW_04::DIS_DR_RVW_04(const ::default_init_tag&)
    : super(*static_cast< ::default_init_tag* >(0))
{
    clinit();
}

deadreckoning::DIS_DR_RVW_04::DIS_DR_RVW_04()
    : DIS_DR_RVW_04(*static_cast< ::default_init_tag* >(0))
{
    ctor();
}

void deadreckoning::DIS_DR_RVW_04::ctor()
{
    super::ctor();
    init();
}

void deadreckoning::DIS_DR_RVW_04::init()
{
...
void deadreckoning::DIS_DR_RVW_04::run()
{
    try {
        while (true) {
            deltaCt++;
...
void deadreckoning::DIS_DR_RVW_04::makeThisDR() /* throws(Exception) */
{
...
java::lang::Class* deadreckoning::DIS_DR_RVW_04::class_()
{
    static ::java::lang::Class* c = ::class_(u"deadreckoning.DIS_DR_RVW_04", 27);
    return c;
}

java::lang::Class* deadreckoning::DIS_DR_RVW_04::getClass0()
{
    return class_();
}
