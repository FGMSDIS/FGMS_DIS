...
public:
	...
	*/
	...
	/**
	* @brief enable logging of a single class
	* @param c the class to be enabled
	*/
	static void enable_log_class ( sgDebugClass c );

	/**
	* @brief disable logging of a single class
	* @param c the class to be disabled
	*/
...
public:
	...
	*/
	 ...
	 */
	inline void setuserdatestr ( DATEFUNC udsf )
	{
		userdatestr=udsf;
	};
	 ...
	 */
	inline void enable_with_date ( bool enable )
	{
		with_date = enable;
	};
	bool        with_date;
